(function($){
	...
	$.fn.pagination.defaults.nav.first.iconCls = 'pagination-first';
	$.fn.pagination.defaults.nav.prev.iconCls = 'pagination-prev';
	$.fn.pagination.defaults.nav.next.iconCls = 'pagination-next';
	$.fn.pagination.defaults.nav.last.iconCls = 'pagination-last';
